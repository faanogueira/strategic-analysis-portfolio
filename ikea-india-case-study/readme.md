...
![IKEA India](https://img.shields.io/badge/Case%20Study-IKEA%20India-0051BA?style=for-the-badge&logo=ikea&logoColor=white)
![Framework](https://img.shields.io/badge/Framework-9S%20Matrix-FFD500?style=for-the-badge)
...
graph TB
    ...
    H[Stakeholders] -.-> A
    H -.-> G
    I[Social Responsibility] -.-> A
    I -.-> H
    
    style A fill:#0051BA,color:#fff
    style B fill:#0051BA,color:#fff
    style C fill:#0051BA,color:#fff
    style D fill:#0051BA,color:#fff
    style E fill:#0051BA,color:#fff
    style F fill:#0051BA,color:#fff
    style G fill:#0051BA,color:#fff
    style H fill:#FFD500,color:#000
    style I fill:#FFD500,color:#000
```
...
```mermaid
flowchart LR
    A[1. Identificação<br/>das 9 Dimensões] --> B[2. Mapeamento de<br/>Desalinhamentos]
    B --> C[3. Análise do<br/>Valor Agregado<br/>da 9S vs 7S]
    C --> D[4. Análise de<br/>Fluxo de<br/>Influência]
    D --> E[5. Recomendações<br/>Acionáveis por<br/>Dimensão]
    
    style A fill:#0051BA,color:#fff
    style B fill:#0051BA,color:#fff
    style C fill:#FFD500,color:#000
    style D fill:#FFD500,color:#000
    style E fill:#0051BA,color:#fff
```
...
![Analysis](https://img.shields.io/badge/Analysis-Strategic-blue?style=flat)
